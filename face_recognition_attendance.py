...
student1_image = face_recognition.load_image_file('faces/hamza.jpeg')
student1_encoding = face_recognition.face_encodings(student1_image)[0]

student2_image = face_recognition.load_image_file('faces/talha.webp')
